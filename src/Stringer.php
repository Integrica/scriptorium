<?php
/**
 * This class, originally named `Stringer`, is derived from the 
 * Filament Shield package by Bezhan Salleh.
 *
 * Filament Shield is a package designed for managing role-based 
 * access control (RBAC) in Laravel Filament.
 *
 * Original Author: Bezhan Salleh
 * Original Source: https://github.com/bezhanSalleh/filament-shield
 * License: MIT
 *
 * Note: This class has been or will be modified for use in Scriptorium.
 * Please refer to the original repository for the unmodified version.
 */
...
namespace Integrica\Scriptorium;
...
class Stringer
{
    ...
    public static function forString(string $content): static
    {
        return (new static(null))->setContent($content);
    }
